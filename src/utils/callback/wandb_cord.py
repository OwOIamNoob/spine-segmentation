...
class WandbCallback(Callback):
    ...
    def build_img(self, predict_seg, prefix="", cmap='viridis'):
        ...
        sagittal_view = torch.sum(predict_seg, dim=0)
        sagittal_view /= sagittal_view.max()
        sagittal_view = torch.rot90(sagittal_view, 1, dims=(0, 1))
        # if cmap == 'viridis':
        sagittal_view = cm.viridis(sagittal_view.cpu())[..., :3]
